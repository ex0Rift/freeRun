...
// include: /tmp/tmp37o9_o0u.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/game.data';
...
Module['FS_createPath']("/assets", "player", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web/game.data');

      };
      Module['addRunDependency']('datafile_web/game.data');
    ...
    loadPackage({"files": [{"filename": "/assets/ground/dirt.png", "start": 0, "end": 852}, {"filename": "/assets/ground/grass.png", "start": 852, "end": 1880}, {"filename": "/assets/player/player.png", "start": 1880, "end": 2290}, {"filename": "/assets/player/player_jump.png", "start": 2290, "end": 2719}, {"filename": "/assets/player/player_left.png", "start": 2719, "end": 3195}, {"filename": "/assets/player/player_left_walk.png", "start": 3195, "end": 3664}, {"filename": "/assets/player/player_right.png", "start": 3664, "end": 4158}, {"filename": "/assets/player/player_right_walk.png", "start": 4158, "end": 4645}], "remote_package_size": 4645});

  })();

// end include: /tmp/tmp37o9_o0u.js
// include: /tmp/tmp6q0hkv4n.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp6q0hkv4n.js
// include: /tmp/tmpu8593n3w.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpu8593n3w.js
...
var ASM_CONSTS = {
  100724: () => { if (document.fullscreenElement) return 1; },  
 100770: () => { return Module.canvas.width; },  
 100802: () => { return parseInt(Module.canvas.style.width); },  
 100850: () => { document.exitFullscreen(); },  
 100877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100950: () => { if (document.fullscreenElement) return 1; },  
 100996: () => { return Module.canvas.width; },  
 101028: () => { return screen.width; },  
 101053: () => { document.exitFullscreen(); },  
 101080: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101213: () => { return window.innerWidth; },  
 101239: () => { return window.innerHeight; },  
 101266: () => { if (document.fullscreenElement) return 1; },  
 101312: () => { return Module.canvas.width; },  
 101344: () => { return parseInt(Module.canvas.style.width); },  
 101392: () => { if (document.fullscreenElement) return 1; },  
 101438: () => { return Module.canvas.width; },  
 101470: () => { return screen.width; },  
 101495: () => { return window.innerWidth; },  
 101521: () => { return window.innerHeight; },  
 101548: () => { if (document.fullscreenElement) return 1; },  
 101594: () => { return Module.canvas.width; },  
 101626: () => { return screen.width; },  
 101651: () => { document.exitFullscreen(); },  
 101678: () => { if (document.fullscreenElement) return 1; },  
 101724: () => { return Module.canvas.width; },  
 101756: () => { return parseInt(Module.canvas.style.width); },  
 101804: () => { document.exitFullscreen(); },  
 101831: ($0) => { Module.canvas.style.opacity = $0; },  
 101869: () => { return screen.width; },  
 101894: () => { return screen.height; },  
 101920: () => { return window.screenX; },  
 101947: () => { return window.screenY; },  
 101974: () => { return window.devicePixelRatio; },  
 102010: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102063: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102114: () => { Module.canvas.style.cursor = 'none'; },  
 102151: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102407: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102458: () => { if (document.pointerLockElement) return 1; },  
 102505: () => { if (document.fullscreenElement) return 1; },  
 102551: () => { return window.innerWidth; },  
 102577: () => { return window.innerHeight; }
};
